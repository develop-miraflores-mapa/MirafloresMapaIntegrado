...
<head>
		...
		<script type="text/javascript" src="<c:url value="/bootbox/js/bootbox.min.js" />"></script>
		...
		<link href="<c:url value="/css/vertical-responsive-menu.min.css" />" rel="stylesheet">
...
<body>
	...
	<div id="actualizarBtn">
		...
		<input type="range" class="form-control" style="width: 160px;; display: inline-block;" min="-30" max="30" value="0" class="slider" id="myRange">
  		  -->
		<input type="text" class="form-control" style="width: 200px;; display: inline-block;" id="aproximarCalles" placeholder="Aproximar ubicación">
		<input type="text" class="form-control" style="width: 100px;; display: inline-block;"id="inputIncidencia" placeholder="Id.Incid" onkeypress="return isNumber(event)">
		<input type="text" class="form-control" style="width: 100px;; display: inline-block;"id="inputNroCasoVoxiva" placeholder="N.Voxiva" onkeypress="return isNumber(event)">
		<%-- <c:if test="${usuarioLoginMap.ideRolRol < 1002 || usuarioLoginMap.ideRol == 901 
						|| usuarioLoginMap.ideRol == 903}">
			<input type="text" class="form-control" style="width: 100px;; display: inline-block;" id="inputIncidencia" placeholder="Id.Incid" onkeypress="return isNumber(event)">
			<input type="text" class="form-control" style="width: 100px;; display: inline-block;" id="inputNroCasoVoxiva" placeholder="N.Voxiva" onkeypress="return isNumber(event)">
			<!-- <select class="form-control" id="inputArea"  style="width: 160px;; display: inline-block;" onkeypress="return isNumber(event)">
		...
		<%-- 
		<c:if test="${usuarioLoginMap.ideRol == 901 || usuarioLoginMap.ideRol == 903}">
			<!-- <input type="text" class="form-control" style="width: 100px;; display: inline-block;" id="inputIncidencia" placeholder="Id.Incid" onkeypress="return isNumber(event)">
			<input type="text" class="form-control" style="width: 100px;; display: inline-block;" id="inputNroCasoVoxiva" placeholder="N.Voxiva" onkeypress="return isNumber(event)"> -->
			<select class="form-control" id="inputArea2"  style="width: 160px;; display: inline-block;" onkeypress="return isNumber(event)">
				    <option>Todas las areas</option>
				    <option>Area 1</option>
				    <option>Area 2</option>
				    <option>Area 3</option>
		...
		<c:if test="${usuarioLoginMap.ideRol == 901}">
			...
			<button id="switchTimelap" data-toggle="tooltip" data-placement="top" title="Activar/desactivar modo histórico" class="btn btn-default btn-md">
				<i id="iconTimelapShow" class="glyphicon glyphicon-time"></i>
			</button>
			 -->
			<button id="switchExposicion" data-toggle="tooltip"
				data-placement="top" title="Activar/desactivar modo presentación"
		...
		<!-- <button id="showAreas" data-toggle="tooltip" data-placement="top"
				title="Mostrar/ocultar áreas" class="btn btn-default btn-md">A
				<i id="polygonSubzonasShow" class="fa fa-phone-square"></i>
		</button> -->
		<button id="showAreas" data-toggle="tooltip" data-placement="top" title="Mostrar/ocultar areas" class="btn btn-default btn-md">A</button>
		<button id="showZonas" data-toggle="tooltip" data-placement="top" title="Mostrar/ocultar zonas" class="btn btn-default btn-md">Z</button>
		<button id="showSubzonas" data-toggle="tooltip" data-placement="top" title="Mostrar/ocultar Subzonas" class="btn btn-default btn-md">SZ</button>
		<c:if test="${usuarioLoginMap.ideRolRol > 1004 || usuarioLoginMap.ideRol == 901 || usuarioLoginMap.ideRol == 903 || usuarioLoginMap.ideRol == 992}">
			<button id="showCamaras" data-toggle="tooltip" data-placement="top" title="Mostrar/Ocultar Cámaras" class="btn btn-default btn-md">
				<i id="iconCamaraShow" class="fa fa-video-camera"></i>
			</button>
		</c:if>
		<c:if test="${usuarioLoginMap.ideRolRol < 1002}">
			<button id="myCasos" data-toggle="tooltip" data-placement="top" title="Mostrar sólo mis casos" class="btn btn-default btn-md">
				<i id="iconVoxivaShow" class="fa fa-phone-square"></i>
			</button>
		</c:if>
		<div class="btn-group">
			<%-- <a href="#" style="min-width: 145px;" class="btn btn-danger">${usuarioLoginMap.desLoginUser}</a> --%>
			<a href="#" style="min-width: 145px;" class="btn btn-default" id="btnUsuario">${usuarioLoginMap.desLoginUser}</a> <a href="#"
				class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="true" id="btnDropdown"><span class="caret"></span></a>
			<ul class="dropdown-menu">
				<c:if test="${usuarioLoginMap.ideRol == 901 || usuarioLoginMap.ideRol == 903}">
					<li><a target="_blank" href="/mobileApps/cierre-calles/mapa/admin">Administración</a></li>
				</c:if>
				<c:if test="${usuarioLoginMap.ideRol == 901}">
					<li><a target="_blank" href="/mobileApps/cierre-calles/mapa/audit">Auditoría</a></li>
				</c:if>
				<c:if test="${usuarioLoginMap.ideRol == 901 || usuarioLoginMap.ideRol == 903 || usuarioLoginMap.ideRol == 902 || usuarioLoginMap.ideRol == 992}">
	...
	<header class="header clearfix" style="z-index: 150;">
		...
		<div style="width: 35px; height: 35px; background: url(/mobileApps/images/logo_alerta_35x35.jpg); float: left; margin: 7px 5px 0px 7px;">
			&nbsp;
		</div>
		<h1 id="titulo_sistema_init">Mapa Integrado de Seguridad Ciudadana</h1>
	</header>

	<div id="nav-exposicion" hidden >
		<nav class="vertical_nav" style="z-index: 999; width: 400px;"></nav>
	</div>
			...
			-->
				<c:if test="${usuarioLoginMap.opcRtransito == 'S'}">
					<li class="menu--item" id="radio4"><a href="#"
						class="menu--link menu-link-activo" title="Radio Tránsito"
				...
				<c:if test="${usuarioLoginMap.opcRpolicia == 'S'}">
					...
					<li class="menu--item" id="radio5"><a href="#"
						class="menu--link menu-link-activo" title="Radio Policía"
				...
				<c:if test="${usuarioLoginMap.opcRserenazgo == 'S'}">
					<li class="menu--item" id="radio6"><a href="#"
						class="menu--link menu-link-activo" title="Radio Serenazgo"
					...
					<li class="menu--item" id="radio8"><a href="#"
						class="menu--link menu-link-activo" title="Radio Motocicleta"
					...
					<li class="menu--item" id="radio10"><a href="#"
						class="menu--link menu-link-activo" title="Radio Automóvil"
					...
					<li class="menu--item" id="radio11"><a href="#"
						class="menu--link menu-link-activo" title="Radio Ambulancia"
						data-tipo="tetra11"> <i class="menu--icon  fa fa-fw"><img
								class="icon-img-menu"
								src="<c:url value="/images/ambulancia.png" />" /></i> <span
							class="menu--label">Ambulancia</span>
					</a></li>
				</c:if>
				<c:if test="${usuarioLoginMap.opcRfiscalizacion == 'S'}">
					<li class="menu--item" id="radio7"><a href="#"
						class="menu--link menu-link-activo" title="Radio Fiscalización"
				...
				<c:if test="${usuarioLoginMap.opcRapagado == 'S'}">
					<li class="menu--item" id="radio2"><a href="#"
						class="menu--link" title="Radio Apagado" data-tipo="tetra2"> <i
				...
				<c:if test="${usuarioLoginMap.opcRotros == 'S'}">
					<li class="menu--item" id="radio3"><a href="#"
						class="menu--link" title="Radio Otros" data-tipo="tetra3"> <i
							class="menu--icon  fa fa-fw"><img class="icon-img-menu"
				...
				<c:if test="${usuarioLoginMap.opcVig1 == 'S'}">
					<li class="menu--item" id="vigilante1"><a href="#"
						class="menu--link" title="Vigilantes Area 1" data-tipo="vigilante1"> <i
							class="menu--icon  fa fa-fw"><img class="icon-img-menu"
				...
				<c:if test="${usuarioLoginMap.opcVig2 == 'S'}">
					<li class="menu--item" id="vigilante2"><a href="#"
						class="menu--link" title="Vigilantes Area 2" data-tipo="vigilante2"> <i
							class="menu--icon  fa fa-fw"><img class="icon-img-menu"
				...
				<c:if test="${usuarioLoginMap.opcVig3 == 'S'}">
					<li class="menu--item" id="vigilante3"><a href="#"
						class="menu--link" title="Vigilantes Area 3" data-tipo="vigilante3"> <i
							class="menu--icon  fa fa-fw"><img class="icon-img-menu"
	...
	<div id="loading" style="width: 100px; margin: 0 auto;">
		<img style="display: none; margin-top: 100px; width: 45%" src="<c:url value="/images/loading.gif" />" />
	</div>

	<div class="wrapper" id="map-canvas"></div>

	<div class="modal fade" id="myModal" style="margin-top: 100px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	<div id="myMapModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	      	<button id="btnPlay2" data-toggle="tooltip" data-placement="top" title="Play" class="btn btn-default btn-md">Play</button>
			<button id="btnStop2" data-toggle="tooltip" data-placement="top" title="Stop" class="btn btn-default btn-md">Stop</button>
			<input type="range" class="form-control" style="width: 160px;; display: inline-block;" min="-30" max="30" value="0" class="slider" id="myRange">
	  		<p style="width: 100px;; display: inline-block;">Instante (min): <span id="minuto" ></span></p>
	...
	<script type="text/javascript">
	   var storeArray = new Array(
			...
			var myOptions = {
			  ...
			  var map2 = new google.maps.Map(document.getElementById("map-canvas-model"), myOptions); 
 ...
 --%>
	...
	<script>
		...
		function fnInside(id){
			...
			MapaIncidencias.ajaxVoxivaExposicion(id,null,null,null);
		}
