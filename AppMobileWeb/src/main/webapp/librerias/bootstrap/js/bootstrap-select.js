...
(function ($) {
  ...
  var Selectpicker = function (element, options, e) {
    ...
    this.onSelectedItem = Selectpicker.prototype.onSelectedItem;
      ...
      this.$menu.on('click', 'li a', function (e) {
        ...
        if (!that.isDisabled() && !$this.parent().hasClass('disabled')) {
          ...
          if ((prevValue != that.$element.val() && that.multiple) || (prevIndex != that.$element.prop('selectedIndex') && !that.multiple)) {
            that.$element.change();
            if(that.options && that.options.onSelectedItem)
              {
              	that.options.onSelectedItem($option.val(),$option,that);
              }
          }
...
//    
//    onSelectedItem:function(fn){
//    	var valItemSelected;
//    	if (typeof value !== 'undefined') {
//        this.$element.val(value);
//        this.render();
//
//        valItemSelected = this.$element;
//      } else {
//        valItemSelected = this.$element.val();
//      }
//    
//      console.log('esta en el metodo')
//      if(fn)
//      {
//      	fn(valItemSelected,this.$element);
//      }
//    },
